# Diese Ausgabedateien sind veraltet

Die Dateien in diesem Verzeichnis (Schaltplan-PDF, Layout-PDFs, Stückliste, 3D-Bild und die SVG-Ansichten) gehören
...
Sie zeigen nicht den aktuellen Entwurf. Vorher einmal
